...
const SignUp = () => {
  return (
    ...
    >
      ...
      <div className="w-full max-w-md p-6 my-10 space-y-2 bg-white shadow-md rounded-lg">
        ...
        <form className="space-y-2">
          ...
          <button
            type="submit"
            className="w-full py-2 bg-primary text-white text-xl font-bold rounded-md shadow hover:bg-secondary focus:ring focus:ring-offset-2 focus:ring-primary"
          >
            Sign Up
          </button>
        </form>
        ...
        <div className="flex justify-center px-4 mt-2">
          <Link to="/login" className="flex items-center gap-3 px-4 justify-center mt-2 w-full text-gray-600 transition-colors duration-300 transform border rounded-lg">
            <FcGoogle />
